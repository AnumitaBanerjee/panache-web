...
const CounsellorDashboard = () => {
    ...
    return (
        <>
            <div className="content-panel dashboard-agent dashboard-counsellor">
                <div className="row mb-4">
                    <div className="col-lg-3 col-sm-12">
                        <div className='icon-box secondary'>
                            <div className='icon-box-t'>
                                <Image
                                    src={`${process.env.NEXT_PUBLIC_IMAGE_PATH}/registered-students-icon.svg`}
                                    alt="Panache"
                                    width={26}
                                    height={38}
                                    priority={true}
                    ...
                    <div className="col-lg-3 col-sm-12">
                        <div className='icon-box primary'>
                            <div className='icon-box-t'>
                                <Image
                                    src={`${process.env.NEXT_PUBLIC_IMAGE_PATH}/submitted-applications-icon.svg`}
                                    alt="Panache"
                                    width={30}
                                    height={31}
                                    priority={true}
                    ...
                    <div className="col-lg-3 col-sm-12">
                        <div className='icon-box primary'>
                            <div className='icon-box-t'>
                                <Image
                                    src={`${process.env.NEXT_PUBLIC_IMAGE_PATH}/application-success-icon.svg`}
                                    alt="Panache"
                                    width={31}
                                    height={31}
                                    priority={true}
                    ...
                    <div className="col-lg-3 col-sm-12">
                        <div className='icon-box secondary'>
                            <div className='icon-box-t'>
                                <Image
                                    src={`${process.env.NEXT_PUBLIC_IMAGE_PATH}/student-enrollment-icon.svg`}
                                    alt="Panache"
                                    width={32}
                                    height={32}
                                    priority={true}
                            ...
                            <div className='icon-box-b'>
                                <span>Student Enrollment Stats</span>
                            </div>
                        </div>
                    </div>
                </div>
